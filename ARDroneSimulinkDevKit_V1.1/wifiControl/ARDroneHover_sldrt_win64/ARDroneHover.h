...
typedef struct {
  ...
  uint8_T data[496];
  char_T cmd_data[148];
  char_T cmd_data_m[148];
  int8_T status[32];                   /* '<S1>/ARDrone data decoding' */
  char_T binData[32];
  char_T binData2[32];
  ...
  int32_T hex_size_cx[2];
  int32_T hex_size_b[2];
  int32_T hex_size_p[2];
  int32_T hex_size_cv[2];
...
typedef struct {
  /* Pooled Parameter (Expression: PacketID)
   * Referenced by:
   *   '<S1>/Packet Input'
   *   '<S7>/Packet Output'
   *   '<S10>/Packet Output1'
...
#define ConstParam                     ConstP_ARDroneHover_T
#define rtcP                           ARDroneHover_ConstP
...
/* Constant parameters (auto storage) */
extern const ConstP_ARDroneHover_T ARDroneHover_ConstP;
 ...
 *
 * Block '<S13>/proportional control gain' : Eliminated nontunable gain of 1
 * Block '<S15>/Gain2' : Eliminated nontunable gain of 1
 * Block '<S15>/Gain3' : Eliminated nontunable gain of 1
 ...
 * Block '<Root>/commands enabled' : Unused code path elimination
 * Block '<Root>/land' : Unused code path elimination
 * Block '<Root>/stop' : Unused code path elimination
 */
